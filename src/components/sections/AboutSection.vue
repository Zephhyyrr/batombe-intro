<template>
  <section id="tentang" class="py-20 bg-white">
    <div class="max-w-6xl mx-auto px-4">
      <h2 class="text-4xl font-bold text-center text-red-900 mb-16">Tentang Batombe</h2>
      <div class="grid md:grid-cols-3 gap-8">
        <div class="bg-gradient-to-br from-red-50 to-orange-50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition">
          <div class="w-16 h-16 bg-red-700 rounded-xl flex items-center justify-center mb-6">
