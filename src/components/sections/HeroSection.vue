<template>
  <section id="beranda" class="pt-20 pb-32 px-4 bg-[#FFF8E6]">
    <div class="max-w-6xl mx-auto">
      <div class="grid md:grid-cols-2 gap-12 items-center">
        
        <!-- Text Content - Left Side -->
        <div class="order-2 md:order-1">
          <h1 class="text-5xl md:text-7xl font-bold text-red-900 mb-6">
            Batombe
          </h1>
          <p class="text-2xl md:text-3xl text-red-800 mb-4">
        ...
        <div class="order-1 md:order-2 flex justify-center md:justify-end">
          <img 
            src="../../assets/fiturr.png"
            alt="Logo Batombe"
            class="max-w-[420px] w-full object-contain drop-shadow-2xl rounded-2xl"
          />
        </div>
